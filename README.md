...
This repository contains a simplified implementation of a Kafka-like distributed messaging system. The project includes
several assignments to help you understand and implement key components of the system.
...
To get started with the assignments, clone this repository and import it into your favorite Java IDE. Each assignment is
marked with a comment in the respective file.
